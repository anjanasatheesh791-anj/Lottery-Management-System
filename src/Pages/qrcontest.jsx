  ...
  const fetchContests = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        "http://localhost/Lottery%20Management%20System/Lottery-Management-System/Backend/api/get_contests.php"
      );
  ...
  selectedContest && (
    ...
    <div className="mt-12 bg-gray-900 border border-gray-800 rounded-3xl p-10 text-center">
      ...
      <div className="bg-white inline-block p-5 rounded-2xl">
        ...
        <QRCodeCanvas
         value={`http://192.168.29.17:5173/join-contest/${selectedContest.id}`}
          size={250}
        />
      ...
      <p className="text-gray-400 mt-6 break-all">
        {`http://192.168.29.17:5173/join-contest/${selectedContest.id}`}
      </p>
